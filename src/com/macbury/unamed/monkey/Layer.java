package com.macbury.unamed.monkey;
...
public class Layer {
   ...
   * used if the layer was loaded using TiledMap
   * 
   * @author liamzebedee
   * @throws SlickException
   */
  public ArrayList<Tile> getTiles() throws SlickException {
    if (tmap == null) {
      throw new SlickException(
          "This method can only be used with Layers loaded using TiledMap");
    }
   ...
   * if the layer was loaded using TiledMap
   * 
   * @author liamzebedee
   * @param tilesetName
   ...
   * layer was loaded using TiledMap
   * 
   * @author liamzebedee
   * @param x
